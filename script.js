...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      descImpermeability: "The image shows an air tightness test of a building, commonly called a “blower door test”.<br>It shows a door fitted with a red airtight sheet featuring:<br>a large fan installed in the doorway, a measuring device (manometer/controller) attached on the side, cables and monitoring instruments.<br>The principle of this device is to put the building under negative or positive pressure in order to measure air leaks. This allows the assessment of:<br>the airtightness of the building envelope,<br>uncontrolled air infiltration,<br>overall energy performance.<br>It is often used in new construction or renovation projects to verify compliance with energy efficiency standards.",
    ...
    fr: {
      ...
      descImpermeability: "L’image montre un test d’étanchéité à l’air d’un bâtiment, appelé généralement un “blower door test”.<br>On y voit une porte équipée d’une toile rouge hermétique avec :<br>un gros ventilateur installé dans l’ouverture, un appareil de mesure (manomètre/contrôleur) fixé sur le côté, des câbles et instruments de contrôle.<br>Le principe de ce dispositif est de mettre le logement en dépression ou surpression afin de mesurer les fuites d’air. Cela permet d’évaluer :<br>l’étanchéité de l’enveloppe du bâtiment,<br>les infiltrations d’air parasites,<br>la performance énergétique globale.<br>C’est souvent utilisé dans les constructions neuves ou les rénovations pour vérifier la conformité aux normes énergétiques.",
    ...
    es: {
      ...
      descImpermeability: "La imagen muestra una prueba de estanqueidad al aire de un edificio, comúnmente llamada “blower door test”.<br>En ella se ve una puerta equipada con una lona roja hermética que incluye:<br>un gran ventilador instalado en la abertura, un dispositivo de medición (manómetro/controlador) fijado en el lateral, cables e instrumentos de control.<br>El principio de este dispositivo es poner el edificio en depresión o sobrepresión para medir las fugas de aire. Esto permite evaluar:<br>la estanqueidad de la envolvente del edificio,<br>las infiltraciones de aire no deseadas,<br>el rendimiento energético global.<br>Se utiliza a menudo en construcciones nuevas o renovaciones para verificar el cumplimiento de las normas de eficiencia energética.",
