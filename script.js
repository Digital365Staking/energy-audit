...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      titleMaricela: "Maricela, Marketing Assistant (Madrid)",
    ...
    fr: {
      ...
      titleMaricela: "Maricela, Assistante marketing (Madrid)",
    ...
    es: {
      ...
      titleMaricela: "Maricela, Asistente de marketing (Madrid)",
