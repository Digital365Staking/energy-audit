...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      titlePaola: "Paola, Marketing Assistant (Madrid)", headLocalLM: "What are local LLMs ?", launchLocalLM: "💳 PAID COURSES",
    ...
    fr: {
      ...
      titlePaola: "Paola, Assistante marketing (Madrid)", headLocalLM: "Que sont les LLM locaux ?", launchLocalLM: "💳 COURS PAYANTS",
    ...
    es: {
      ...
      titlePaola: "Paola, Asistente de marketing (Madrid)", headLocalLM: "¿ Qué son los LLM locales ?", launchLocalLM: "💳 CURSOS DE PAGO",
    ...
    de: {
      ...
      titlePaola: "Paola, Marketingassistentin (Madrid)", headLocalLM: "Was sind lokale LLMs ?", launchLocalLM: "💳 KOSTENPFLICHTIGE KURSE",
    ...
    pt: {
      ...
      titlePaola: "Paola, Assistente de Marketing (Madri)", headLocalLM: "O que são os LLMs locais ?", launchLocalLM: "💳 CURSOS PAGOS",
    ...
    nl: {
      ...
      titlePaola: "Paola, marketingassistent, Madrid", headLocalLM: "Wat zijn lokale LLM's ?", launchLocalLM: "💳 BETAALDE CURSUSSEN",
    ...
    da: {
      ...
      titlePaola: "Paola, marketingassistent, Madrid", headLocalLM: "Hvad er lokale LLM'er ?", launchLocalLM: "💳 BETALTE KURSER",
    ...
    sv: {
      ...
      titlePaola: "Paola, marknadsassistent, Madrid", headLocalLM: "Vad är lokala LLM:er ?", launchLocalLM: "💳 BETALDA KURSER",
    ...
    no: {
      ...
      titlePaola: "Paola, markedsassistent, Madrid", headLocalLM: "Hva er lokale LLM-er ?", launchLocalLM: "💳 BETALTE KURS",
      ...
      titlePaola: "Paola, markkinointiassistentti, Madrid", headLocalLM: "Mitä ovat paikalliset LLM:t ?", launchLocalLM: "💳 MAKSULLISET KURSSIT",
