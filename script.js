...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    ...
    es: {
      ...
      titleDona: "Dona, Directora de marketing (Ginebra)", headerConvIFCJSON: "Nuevo: IFC/DXF → JSON y visualización 3D",
    ...
    de: {
      ...
      titleDona: "Dona, Marketingleiterin (Genf)", headerConvIFCJSON: "Neu: IFC/DXF → JSON & 3D-Visualisierung",
    ...
    pt: {
      ...
      titleDona: "Dona, Diretora de Marketing (Genebra)", headerConvIFCJSON: "Novo: IFC/DXF → JSON e Visualização 3D",
    ...
    nl: {
      ...
      titleDona: "Dona, marketingdirecteur, Genève", headerConvIFCJSON: "Nieuw: IFC/DXF → JSON & 3D-visualisatie",
    ...
    da: {
      ...
      titleDona: "Dona, marketingdirektør, Genève", headerConvIFCJSON: "Nyhed: IFC/DXF → JSON & 3D-visualisering",
    ...
    sv: {
      ...
      titleDona: "Dona, marknadschef, Genève", headerConvIFCJSON: "Nyhet: IFC/DXF → JSON & 3D-visualisering",
    ...
    no: {
      ...
      titleDona: "Dona, markedsdirektør, Genève", headerConvIFCJSON: "Nyhet: IFC/DXF → JSON & 3D-visualisering",
      ...
      titleDona: "Dona, markkinointijohtaja, Geneve", headerConvIFCJSON: "Uutta: IFC/DXF → JSON & 3D-visualisointi",
