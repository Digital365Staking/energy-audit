...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      headerFree: "✔ Free section • ✔ No access fees • ✔ Ideal for beginners", linkStartTrain: "https://digitalenergyaudit.com/cecb/physic-building/en",
      ...
      headerMidnight: "Do we really need to break free from centralized systems ? Midnight’s challenge",
    ...
    fr: {
      ...
      headerFree: "✔ Partie gratuite • ✔ Aucun frais d’accès • ✔ Idéal pour débutants", linkStartTrain: "https://digitalenergyaudit.com/cecb/physic-building/fr",
      ...
      headerMidnight: "Faut-il vraiment s’affranchir des systèmes centralisés ? Le pari de Midnight",
    ...
    es: {
      ...
      headerFree: "✔ Sección gratuita • ✔ Sin costes de acceso • ✔ Ideal para principiantes", linkStartTrain: "https://digitalenergyaudit.com/cecb/physic-building/es",
      ...
      headerMidnight: "¿ Es realmente necesario liberarse de los sistemas centralizados ? La apuesta de Midnight",
