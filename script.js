...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      office: "( Representative Office )", linkStartESP32: "https://digitalenergyaudit.com/esp32/paid-en", linkConvIFCJSON: "https://3dbimviewer.pages.dev/?lang=en",
      titleDona: "Dona, Marketing Director (Geneva)", headerConvIFCJSON: "IFC/DXF → JSON & 3D Visualization",
      ...
      titleNidia: "Nidia, Marketing Assistant (Madrid)", descLocalLM: "Local <b>LLMs</b> (Large Language Models running on your own machine) are rapidly gaining popularity. Thanks to advances in model optimization and the widespread availability of powerful hardware, it is now possible to use powerful artificial intelligence models without relying on a cloud service. This approach offers many advantages: data privacy, no API costs, offline operation, and complete control over the model and its environment. In this section, you will discover the tools, models, and best practices for installing, configuring, and efficiently using local LLMs, whether for software development, automation, or advanced artificial intelligence projects.",
      titlePaola: "Miriam, Marketing Assistant (Madrid)", headLocalLM: "What are local LLMs ?", launchLocalLM: "💳 PAID COURSES",
      titleAmelia: "Amelia, Marketing Assistant (Madrid)", linkStartLocalLM: "https://digitalenergyaudit.com/locallm/paid-en",
    ...
    fr: {
      ...
      office: "( Bureau de Représentation )", linkStartESP32: "https://digitalenergyaudit.com/esp32/paid-fr", linkConvIFCJSON: "https://3dbimviewer.pages.dev/?lang=fr",
      titleDona: "Dona, Directrice marketing (Genève)", headerConvIFCJSON: "IFC/DXF → JSON & Visualisation 3D",
      titleDiana: "Diana, Assistante marketing (Genève)", drone: "Découvrez notre nouveau service de suivi de chantier par drone :<br><br>Le suivi de chantier par drone permet une documentation visuelle précise et régulière de l’évolution d’un projet de construction. Grâce à notre drone professionnel, nous capturons des images aériennes haute définition qui facilitent la gestion, la coordination et la communication sur vos chantiers entre les différents acteurs : architectes, maîtres d’ouvrage, entreprises générales et bureaux techniques. Chaque mission inclut un plan de vol sur mesure, des livrables exploitables (photos et vidéos) ainsi qu’une intégration fluide dans vos plateformes de gestion de projet.",
      titleNidia: "Nidia, Assistante marketing (Madrid)", descLocalLM: "Les <b>LLMs locaux</b> (Large Language Models exécutés sur votre propre machine) connaissent un essor considérable. Grâce aux progrès de l'optimisation des modèles et à la démocratisation du matériel performant, il est désormais possible d'utiliser des intelligences artificielles puissantes sans dépendre d'un service cloud. Cette approche offre de nombreux avantages : confidentialité des données, absence de coûts liés aux API, fonctionnement hors ligne et contrôle total sur le modèle et son environnement. Dans cette section, vous découvrirez les outils, les modèles et les bonnes pratiques pour installer, configurer et exploiter efficacement des LLMs en local, que ce soit pour le développement, l'automatisation ou des projets d'intelligence artificielle avancés.",
      titlePaola: "Miriam, Assistante marketing (Madrid)", headLocalLM: "Que sont les LLM locaux ?", launchLocalLM: "💳 COURS PAYANTS",
      titleAmelia: "Amelia, Assistante marketing (Madrid)", linkStartLocalLM: "https://digitalenergyaudit.com/locallm/paid-fr", 
    ...
    es: {
      ...
      office: "( Oficina de Representación )", linkStartESP32: "https://digitalenergyaudit.com/esp32/paid-es", linkConvIFCJSON: "https://3dbimviewer.pages.dev/?lang=es",
      titleDona: "Dona, Directora de marketing (Ginebra)", headerConvIFCJSON: "IFC/DXF → JSON y visualización 3D",
      titleDiana: "Diana, Asistente de marketing (Ginebra)", drone: "Descubra nuestro nuevo servicio de seguimiento de obras mediante drones:<br><br>El seguimiento de obras mediante drones permite una documentación visual precisa y periódica de la evolución de un proyecto de construcción. Gracias a nuestro dron profesional, capturamos imágenes aéreas en alta definición que facilitan la gestión, la coordinación y la comunicación en sus obras entre los distintos actores: arquitectos, promotores, empresas generales y oficinas técnicas. Cada misión incluye un plan de vuelo a medida, entregables utilizables (fotos y vídeos), así como una integración fluida en sus plataformas de gestión de proyectos.",
      titleNidia: "Nidia, Asistente de marketing (Madrid)", descLocalLM: "Los <b>LLM locales</b> (Large Language Models que se ejecutan en su propio equipo) están experimentando un gran crecimiento. Gracias a los avances en la optimización de modelos y a la democratización del hardware de alto rendimiento, ahora es posible utilizar potentes inteligencias artificiales sin depender de un servicio en la nube. Este enfoque ofrece numerosas ventajas: privacidad de los datos, ausencia de costes de API, funcionamiento sin conexión y control total sobre el modelo y su entorno. En esta sección descubrirá las herramientas, los modelos y las mejores prácticas para instalar, configurar y utilizar eficazmente LLM locales, ya sea para desarrollo, automatización o proyectos avanzados de inteligencia artificial.",
      titlePaola: "Miriam, Asistente de marketing (Madrid)", headLocalLM: "¿ Qué son los LLM locales ?", launchLocalLM: "💳 CURSOS DE PAGO",
      titleAmelia: "Amelia, Asistente de marketing (Madrid)", linkStartLocalLM: "https://digitalenergyaudit.com/locallm/paid-es",
    ...
    de: {
      ...
      office: "( Repräsentationsbüro )", linkStartESP32: "https://digitalenergyaudit.com/esp32/paid-de", linkConvIFCJSON: "https://3dbimviewer.pages.dev/?lang=de",
      titleDona: "Dona, Marketingleiterin (Genf)", headerConvIFCJSON: "IFC/DXF → JSON & 3D-Visualisierung",
      titleDiana: "Diana, Marketingassistentin (Genf)", drone: "Entdecken Sie unseren neuen Drohnen-Service zur Baustellenüberwachung:<br><br>Die Drohnen-gestützte Baustellenüberwachung ermöglicht eine präzise und regelmäßige visuelle Dokumentation des Fortschritts eines Bauprojekts. Mit unserer professionellen Drohne erstellen wir hochauflösende Luftaufnahmen, die die Verwaltung, Koordination und Kommunikation auf Ihren Baustellen zwischen den verschiedenen Akteuren erleichtern: Architekten, Bauherren, Generalunternehmen und technische Büros. Jede Mission umfasst einen maßgeschneiderten Flugplan, verwertbare Ergebnisse (Fotos und Videos) sowie eine nahtlose Integration in Ihre Projektmanagement-Plattformen.",
      titleNidia: "Nidia, Marketingassistentin (Madrid)", descLocalLM: "Lokale <b>LLMs</b> (Large Language Models, die auf Ihrem eigenen Rechner ausgeführt werden) gewinnen zunehmend an Bedeutung. Dank Fortschritten bei der Modelloptimierung und der zunehmenden Verfügbarkeit leistungsfähiger Hardware ist es heute möglich, leistungsstarke KI-Modelle ohne Cloud-Dienst zu nutzen. Dieser Ansatz bietet zahlreiche Vorteile: Datenschutz, keine API-Kosten, Offline-Betrieb sowie vollständige Kontrolle über das Modell und seine Umgebung. In diesem Abschnitt lernen Sie die Werkzeuge, Modelle und bewährten Methoden kennen, um lokale LLMs effizient zu installieren, zu konfigurieren und einzusetzen – sei es für Softwareentwicklung, Automatisierung oder anspruchsvolle KI-Projekte.",
      titlePaola: "Miriam, Marketingassistentin (Madrid)", headLocalLM: "Was sind lokale LLMs ?", launchLocalLM: "💳 KOSTENPFLICHTIGE KURSE",
      titleAmelia: "Amelia, Marketingassistentin (Madrid)", linkStartLocalLM: "https://digitalenergyaudit.com/locallm/paid-de",
    ...
    pt: {
      ...
      titleAdrien: "Adrien, Engenheiro de IA & Auditor Energético (Genebra, Luxemburgo e Madrid)",
      urlYTB1: "https://www.youtube.com/embed/9He76uCylVQ",
      urlYTB2: "https://www.youtube.com/embed/g2Fs5dMTKCw",
      urlYTB3: "https://www.youtube.com/embed/blwY1Coui_s",
      ...
      titleJohn: "John, CEO & Analista de Dados (Dublin e Madrid)",
      launchTrain: "Iniciar o programa de treinamento", launchESP32: "💳 CURSOS PAGOS",
      office: "( Escritório de Representação )", linkStartESP32: "https://digitalenergyaudit.com/esp32/paid-pt", linkConvIFCJSON: "https://3dbimviewer.pages.dev/?lang=pt",
      titleDona: "Dona, Diretora de Marketing (Genebra)", headerConvIFCJSON: "IFC/DXF → JSON e Visualização 3D",
      titleDiana: "Diana, Assistente de Marketing (Genebra)", drone: "Descubra o nosso novo serviço de monitorização de obras com drones:<br><br>A monitorização de obras com drones permite uma documentação visual precisa e regular da evolução de um projeto de construção. Com o nosso drone profissional, captamos imagens aéreas em alta definição que facilitam a gestão, coordenação e comunicação nas suas obras entre os diferentes intervenientes: arquitetos, donos de obra, empreiteiros gerais e gabinetes técnicos. Cada missão inclui um plano de voo personalizado, entregáveis utilizáveis (fotografias e vídeos), bem como uma integração fluida nas suas plataformas de gestão de projetos.",
      titleNidia: "Nidia, Assistente de Marketing (Madrid)", descLocalLM: "Os <b>LLMs locais</b> (Large Language Models executados no seu próprio computador) estão a ganhar cada vez mais popularidade. Graças aos avanços na otimização dos modelos e à democratização do hardware de elevado desempenho, tornou-se possível utilizar poderosos modelos de inteligência artificial sem depender de serviços na nuvem. Esta abordagem oferece inúmeras vantagens: privacidade dos dados, ausência de custos com APIs, funcionamento offline e controlo total sobre o modelo e o seu ambiente. Nesta secção irá descobrir as ferramentas, os modelos e as melhores práticas para instalar, configurar e utilizar LLMs locais de forma eficiente, seja para desenvolvimento, automação ou projetos avançados de inteligência artificial.",
      titlePaola: "Miriam, Assistente de Marketing (Madrid)", headLocalLM: "O que são os LLMs locais ?", launchLocalLM: "💳 CURSOS PAGOS",
      titleAmelia: "Amelia, Assistente de Marketing (Madrid)", linkStartLocalLM: "https://digitalenergyaudit.com/locallm/paid-pt",
    ...
    nl: {
      ...
      linkStartESP32: "https://digitalenergyaudit.com/esp32/paid-nl", linkConvIFCJSON: "https://3dbimviewer.pages.dev/?lang=nl",
      titleDona: "Dona, marketingdirecteur, Genève", headerConvIFCJSON: "IFC/DXF → JSON & 3D-visualisatie",
      titleDiana: "Diana, marketingassistent, Genève", drone: "Ontdek onze nieuwe drone-service voor bouwplaatsmonitoring:<br><br>Drone-monitoring van bouwplaatsen biedt een nauwkeurige en regelmatige visuele documentatie van de voortgang van een bouwproject. Met onze professionele drone maken wij luchtbeelden in hoge resolutie die het beheer, de coördinatie en communicatie op uw bouwplaatsen tussen de verschillende betrokkenen vergemakkelijken: architecten, opdrachtgevers, aannemers en technische bureaus. Elke opdracht omvat een op maat gemaakt vluchtplan, bruikbare deliverables (foto’s en video’s) en een naadloze integratie in uw projectmanagementplatforms.",
      titleNidia: "Nidia, marketingassistent, Madrid", descLocalLM: "Lokale <b>LLM's</b> (Large Language Models die op uw eigen computer draaien) winnen snel aan populariteit. Dankzij verbeteringen in modeloptimalisatie en de brede beschikbaarheid van krachtige hardware is het nu mogelijk om krachtige AI-modellen te gebruiken zonder afhankelijk te zijn van een clouddienst. Deze aanpak biedt tal van voordelen: gegevensprivacy, geen API-kosten, offline gebruik en volledige controle over het model en zijn omgeving. In deze sectie ontdekt u de hulpmiddelen, modellen en best practices om lokale LLM's efficiënt te installeren, configureren en gebruiken voor ontwikkeling, automatisering of geavanceerde AI-projecten.",
      titlePaola: "Miriam, marketingassistent, Madrid", headLocalLM: "Wat zijn lokale LLM's ?", launchLocalLM: "💳 BETAALDE CURSUSSEN",
      titleAmelia: "Amelia, marketingassistent, Madrid", linkStartLocalLM: "https://digitalenergyaudit.com/locallm/paid-nl",
    ...
    da: {
      ...
      linkStartESP32: "https://digitalenergyaudit.com/esp32/paid-da", linkConvIFCJSON: "https://3dbimviewer.pages.dev/?lang=da",
      titleDona: "Dona, marketingdirektør, Genève", headerConvIFCJSON: "IFC/DXF → JSON & 3D-visualisering",
      titleDiana: "Diana, marketingassistent, Genève", drone: "Oplev vores nye dronebaserede byggepladsopfølgningsservice:<br><br>Dronebaseret opfølgning af byggepladser giver en præcis og regelmæssig visuel dokumentation af udviklingen i et byggeprojekt. Med vores professionelle drone optager vi luftbilleder i høj opløsning, som letter styring, koordinering og kommunikation på dine byggepladser mellem de forskellige aktører: arkitekter, bygherrer, totalentreprenører og ingeniørfirmaer. Hver mission inkluderer en skræddersyet flyveplan, anvendelige leverancer (fotos og videoer) samt en gnidningsfri integration i dine projektstyringsplatforme.",
      titleNidia: "Nidia, marketingassistent, Madrid", descLocalLM: "Lokale <b>LLM'er</b> (Large Language Models, der kører på din egen computer) bliver stadig mere populære. Takket være fremskridt inden for modeloptimering og den brede tilgængelighed af kraftfuld hardware er det nu muligt at anvende avancerede AI-modeller uden at være afhængig af en cloudtjeneste. Denne tilgang giver mange fordele: databeskyttelse, ingen API-omkostninger, offline drift og fuld kontrol over modellen og dens miljø. I dette afsnit finder du værktøjer, modeller og bedste praksis til at installere, konfigurere og udnytte lokale LLM'er effektivt, hvad enten det er til udvikling, automatisering eller avancerede AI-projekter.",
      titlePaola: "Miriam, marketingassistent, Madrid", headLocalLM: "Hvad er lokale LLM'er ?", launchLocalLM: "💳 BETALTE KURSER",
      titleAmelia: "Amelia, marketingassistent, Madrid", linkStartLocalLM: "https://digitalenergyaudit.com/locallm/paid-da",
    ...
    sv: {
      ...
      linkStartESP32: "https://digitalenergyaudit.com/esp32/paid-sv", linkConvIFCJSON: "https://3dbimviewer.pages.dev/?lang=sv",
      titleDona: "Dona, marknadschef, Genève", headerConvIFCJSON: "IFC/DXF → JSON & 3D-visualisering",
      titleDiana: "Diana, marknadsassistent, Genève", drone: "Upptäck vår nya drönartjänst för byggplatsövervakning:<br><br>Drönarbaserad övervakning av byggplatser möjliggör en exakt och regelbunden visuell dokumentation av utvecklingen i ett byggprojekt. Med vår professionella drönare fångar vi högupplösta flygbilder som underlättar styrning, samordning och kommunikation på dina byggarbetsplatser mellan olika aktörer: arkitekter, byggherrar, totalentreprenörer och tekniska konsulter. Varje uppdrag inkluderar en skräddarsydd flygplanering, användbara leverabler (bilder och videor) samt en smidig integration i dina projektledningsplattformar.",
      titleNidia: "Nidia, marknadsassistent, Madrid", descLocalLM: "Lokala <b>LLM:er</b> (Large Language Models som körs på din egen dator) blir allt mer populära. Tack vare framsteg inom modelloptimering och den ökade tillgången till kraftfull hårdvara är det nu möjligt att använda kraftfull artificiell intelligens utan att vara beroende av en molntjänst. Denna metod erbjuder många fördelar: datasekretess, inga API-kostnader, offlineanvändning och fullständig kontroll över modellen och dess miljö. I detta avsnitt får du lära dig om verktyg, modeller och bästa praxis för att installera, konfigurera och använda lokala LLM:er effektivt, oavsett om det gäller utveckling, automatisering eller avancerade AI-projekt.",
      titlePaola: "Miriam, marknadsassistent, Madrid", headLocalLM: "Vad är lokala LLM:er ?", launchLocalLM: "💳 BETALDA KURSER",
      titleAmelia: "Amelia, marknadsassistent, Madrid", linkStartLocalLM: "https://digitalenergyaudit.com/locallm/paid-sv",
    ...
    no: {
      ...
      linkStartESP32: "https://digitalenergyaudit.com/esp32/paid-no", linkConvIFCJSON: "https://3dbimviewer.pages.dev/?lang=no",
      titleDona: "Dona, markedsdirektør, Genève", headerConvIFCJSON: "IFC/DXF → JSON & 3D-visualisering",
      titleDiana: "Diana, markedsassistent, Genève", drone: "Oppdag vår nye dronebaserte tjeneste for byggeplassovervåking:<br><br>Dronebasert overvåking av byggeplasser gir presis og regelmessig visuell dokumentasjon av utviklingen i et byggeprosjekt. Med vår profesjonelle drone tar vi høyoppløselige luftbilder som gjør det enklere med styring, koordinering og kommunikasjon på byggeplassene dine mellom ulike aktører: arkitekter, byggherrer, totalentreprenører og tekniske kontorer. Hver oppdrag inkluderer en skreddersydd flyplan, brukbare leveranser (bilder og videoer) samt sømløs integrasjon i dine prosjektstyringsplattformer.",
      titleNidia: "Nidia, markedsassistent, Madrid", descLocalLM: "Lokale <b>LLM-er</b> (Large Language Models som kjører på din egen datamaskin) blir stadig mer populære. Takket være fremskritt innen modelloptimalisering og den økende tilgjengeligheten av kraftig maskinvare er det nå mulig å bruke avanserte KI-modeller uten å være avhengig av en skytjeneste. Denne tilnærmingen gir mange fordeler: personvern for data, ingen API-kostnader, offline drift og full kontroll over modellen og dens miljø. I denne delen vil du oppdage verktøyene, modellene og beste praksis for å installere, konfigurere og bruke lokale LLM-er effektivt, enten det gjelder utvikling, automatisering eller avanserte kunstig intelligens-prosjekter.",
      titlePaola: "Miriam, markedsassistent, Madrid", headLocalLM: "Hva er lokale LLM-er ?", launchLocalLM: "💳 BETALTE KURS",
      titleAmelia: "Amelia, markedsassistent, Madrid", linkStartLocalLM: "https://digitalenergyaudit.com/locallm/paid-no",
      ...
      office: "Edustusto",
      linkStartESP32: "https://digitalenergyaudit.com/esp32/paid-fi", linkConvIFCJSON: "https://3dbimviewer.pages.dev/?lang=fi",
      titleDona: "Dona, markkinointijohtaja, Geneve", headerConvIFCJSON: "IFC/DXF → JSON & 3D-visualisointi",
      titleDiana: "Diana, markkinointiassistentti, Geneve", drone: "Tutustu uuteen dronepohjaiseen työmaaseurannan palveluumme:<br><br>Dronepohjainen työmaaseuranta mahdollistaa rakennusprojektin etenemisen tarkan ja säännöllisen visuaalisen dokumentoinnin. Ammattimaisella dronellamme kuvaamme korkearesoluutioisia ilmakuvia, jotka helpottavat hallintaa, koordinointia ja viestintää työmaillasi eri toimijoiden välillä: arkkitehdit, rakennuttajat, pääurakoitsijat ja suunnittelutoimistot. Jokainen toimeksianto sisältää räätälöidyn lentosuunnitelman, hyödynnettävät toimitukset (valokuvat ja videot) sekä sujuvan integraation projektinhallinta-alustoihisi.",
      titleNidia: "Nidia, markkinointiassistentti, Madrid", descLocalLM: "Paikalliset <b>LLM:t</b> (Large Language Models, jotka toimivat omalla tietokoneellasi) ovat kasvattaneet suosiotaan merkittävästi. Mallien optimoinnin kehityksen ja tehokkaan laitteiston yleistymisen ansiosta on nykyään mahdollista käyttää tehokkaita tekoälymalleja ilman riippuvuutta pilvipalveluista. Tämä lähestymistapa tarjoaa monia etuja: tietojen yksityisyys, ei API-kustannuksia, offline-käyttö sekä täydellinen hallinta mallista ja sen ympäristöstä. Tässä osiossa tutustut työkaluihin, malleihin ja parhaisiin käytäntöihin paikallisten LLM-mallien asentamiseen, määrittämiseen ja tehokkaaseen hyödyntämiseen ohjelmistokehityksessä, automaatiossa ja edistyneissä tekoälyprojekteissa.",
      titlePaola: "Miriam, markkinointiassistentti, Madrid", headLocalLM: "Mitä ovat paikalliset LLM:t ?", launchLocalLM: "💳 MAKSULLISET KURSSIT",
      titleAmelia: "Amelia, markkinointiassistentti, Madrid", linkStartLocalLM: "https://digitalenergyaudit.com/locallm/paid-fi",
