...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      titlePaola: "Paola, Marketing Assistant (Madrid)", headLocalLM: "What are local LLMs ?", launchLocalLM: "",
    ...
    fr: {
      ...
      titlePaola: "Paola, Assistante marketing (Madrid)", headLocalLM: "Que sont les LLM locaux ?", launchLocalLM: "",
