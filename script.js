...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      titleOlga: "Olga, Marketing Assistant (Madrid)",
    ...
    fr: {
      ...
      titleOlga: "Olga, Assistante marketing (Madrid)",
    ...
    es: {
      ...
      titleOlga: "Olga, Asistente de marketing (Madrid)",
